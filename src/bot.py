...
async def cmd_start(message: Message,  **kwargs):
    ...
    if is_registered:
        ...
        await message.answer(
             "👋 **Добро пожаловать в бота для поиска попутчиков по городам Башкирии!**\n\n"
                "🚗 Проект бесплатный и создан пассажиром, который хочет иметь представление о будущей поездке:\n"
                "🔒 Не беспокойтесь, ваши персональные данные надежно защищены и не хранятся в базе.\n\n"
